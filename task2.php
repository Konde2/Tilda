...
// Задание 2
    ...
    for($i = 1; $i <= 5; $i++) { // создаём 5 строк
        ...
        for($j = 1; $j <= 7; $j++){ // создаём 7 столбцов
            ...
            $randomNumber = mt_rand(1,1000); // каждую ячейку заполняем числами от 1 до 1000

            if (!in_array($randomNumber, $numbers)) { // если этого числа нет в массиве, то оно становится уникальным и добавляем его
